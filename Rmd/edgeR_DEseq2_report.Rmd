...
# Data inport
if (data_origin == "STAR-featureCounts") {
...
results_edgeR <- merge(results_edgeR, annotated, by.x = "ID", by.y = "ensembl_gene_id")
...
results_DESeq2 <- merge(results_DESeq2, annotated, by.x = "ID", by.y = "ensembl_gene_id")
...
common_df <- data.frame(
  ...
  hgnc_symbol = results_edgeR_common$hgnc_symbol,
